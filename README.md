...
Dette repoet inneholder delte ressurser som design system, brand assets, design tokens, API-spesifikasjoner og dokumentasjon.
...
```bash
git clone https://github.com/loopwish/shared.git
cd shared
```
